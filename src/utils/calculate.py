...
def calculate_scores(answers):
    ...
    questions_map = {
        ...
        's': [2, 3, 9, 10, 16, 17, 23, 24, 30, 31,
              37, 38, 44, 45, 51, 52, 58, 59, 65, 66],
        'n': [2, 3, 9, 10, 16, 17, 23, 24, 30, 31,
              37, 38, 44, 45, 51, 52, 58, 59, 65, 66],
        't': [4, 5, 11, 12, 18, 19, 25, 26, 32, 33,
              39, 40, 46, 47, 53, 54, 60, 61, 67, 68],
        'f': [4, 5, 11, 12, 18, 19, 25, 26, 32, 33,
              39, 40, 46, 47, 53, 54, 60, 61, 67, 68],
        'j': [6, 7, 13, 14, 20, 21, 27, 28, 34, 35,
              41, 42, 48, 49, 55, 56, 62, 63, 69, 70],
        'p': [6, 7, 13, 14, 20, 21, 27, 28, 34, 35,
              41, 42, 48, 49, 55, 56, 62, 63, 69, 70]
    }
